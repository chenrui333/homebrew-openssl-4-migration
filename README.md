...
3. Regenerate the normalized site snapshot for executive summary and depth-gate review.
...
This regenerates data/site_snapshot.json and runs `npm run build` in [site/](site/).
