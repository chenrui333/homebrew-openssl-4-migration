# OpenSSL 4 Migration Audit (2026-09-17)
...
|---|---|---:|---:|---|---|---|---|---|
| cmake | openssl-4-migration-staging | 0 | 677 | PENDING | none | missing-pr | gitlab:gitlab.kitware.com/cmake/cmake |  |
| python@3.14 | openssl-4-migration-staging | 0 | 477 | PENDING | none | missing-pr | python |  |
| libssh2 | openssl-4-migration-staging | 0 | 320 | PENDING | none | missing-pr | github:libssh2/libssh2 |  |
| libgit2 | openssl-4-migration-staging | closure | 297 | PENDING | none | missing-pr | github:libgit2/libgit2 |  |
| rust | openssl-4-migration-staging | 1 | 295 | PENDING | none | missing-pr | github:rust-lang/rust | [issues#155397](https://github.com/rust-lang/rust/issues/155397) open |
...
| cryptography | openssl-4-migration-staging | 2 | 18 | PENDING | none | missing-pr | github:pyca/cryptography | [issues#14656](https://github.com/pyca/cryptography/issues/14656) closed |
...
| libfido2 | openssl-4-migration-staging | 0 | 11 | PENDING | none | missing-pr | github:Yubico/libfido2 | [issues#966](https://github.com/Yubico/libfido2/issues/966) closed |
...
|---|---:|---:|---|---|---|
| cmake | 0 | 677 | gitlab:gitlab.kitware.com/cmake/cmake |  | missing-pr |
| python@3.14 | 0 | 477 | python |  | missing-pr |
| libssh2 | 0 | 320 | github:libssh2/libssh2 | [issues](https://github.com/search?q=repo%3Alibssh2%2Flibssh2+%22OpenSSL+4%22&type=issues) | missing-pr |
| libgit2 | closure | 297 | github:libgit2/libgit2 | [issues](https://github.com/search?q=repo%3Alibgit2%2Flibgit2+%22OpenSSL+4%22&type=issues) | missing-pr |
