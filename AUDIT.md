# OpenSSL 4 Migration Audit (2026-05-20)
...
|---|---|---:|---:|---|---|---|---|---|
| python@3.14 | openssl-4-migration-staging | 0 | 468 | PENDING | #280846 | draft, checks-blocked, merge-unstable | python |  |
| rust | openssl-4-migration-staging | 1 | 268 | PENDING | #280863 | draft, checks-blocked, merge-unstable | github:rust-lang/rust | [issues#155397](https://github.com/rust-lang/rust/issues/155397) open |
...
|---|---:|---:|---|---|---|
| python@3.14 | 0 | 468 | python |  | draft, checks-blocked, merge-unstable |
