# OpenSSL 4 Migration Audit (2026-06-12)
...
|---|---|---:|---:|---|---|---|---|---|
| cmake | openssl-4-migration-staging | 0 | 651 | PENDING | none | missing-pr | gitlab:gitlab.kitware.com/cmake/cmake |  |
| python@3.14 | openssl-4-migration-staging | 0 | 472 | PENDING | #280846 | draft, checks-blocked, merge-dirty | python |  |
| libgit2 | openssl-4-migration-staging | closure | 274 | PENDING | none | missing-pr | github:libgit2/libgit2 |  |
...
|---|---:|---:|---|---|---|
| cmake | 0 | 651 | gitlab:gitlab.kitware.com/cmake/cmake |  | missing-pr |
| python@3.14 | 0 | 472 | python |  | draft, checks-blocked, merge-dirty |
| libgit2 | closure | 274 | github:libgit2/libgit2 | [issues](https://github.com/search?q=repo%3Alibgit2%2Flibgit2+%22OpenSSL+4%22&type=issues) | missing-pr |
