...
.PHONY: help build dep-tree status checklist audit site-data site migrate migrate-dry clean
...
help:
	...
	@echo "  site-data           Regenerate data/site_snapshot.json"
	@echo "  site                Regenerate site data and build Astro static site"
